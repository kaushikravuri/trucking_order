                    ...
                    <div class="card-body"> 
                        <form action="truckingorder.php" method = "post">
                            ...
                            <div class="mb-4">        
                                <div class="row">
                                    <div class="col-6">
                                        <label for="exampleFormControlInput1" class="form-label">Enter distance to warehouse</label>
                                        <input type="text" class="form-control" id = "mileage" name = "mileage" placeholder="">
                                    </div>
                                    <div class="col-6">
                                        <label for="exampleFormControlInput1" class="form-label">Enter ETA</label>
