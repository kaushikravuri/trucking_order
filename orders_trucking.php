...
if($_SERVER['REQUEST_METHOD'] == "GET")
{
    ...
    if (sizeof($_GET,1) == 1)
    {
        ...
        $trucking_company_id = $_GET['tid'];
        // Reading from the data base
        $query = "select * from truck_orders where truckingCompanyId = '{$trucking_company_id}'";
            ...
            <div class="col-8">
                <div class="card p-2">
                    <div class="card-body"> 
                            ...
                            <div class="mb-4">
                                <label for="exampleFormControlInput1" class="form-label">Select your trucking company</label>
                                ...
                                <div class="dropdown">
                                    <select class="form-select" aria-label="Default select example" onchange="location = this.value;" id="containerId">
                                        ...
                                        <?php for ($row = 0; $row < count($trucking_companies_data); $row++) { ?>
                                            ...
                                            <option name="<?php echo $trucking_companies_data[$row][0];?>" value="http://localhost/Container-Scheduling-and-management/orders_trucking.php?tid=<?php echo $trucking_companies_data[$row][0]; ?>" >
      ...
      <div class="row mt-4">
          ...
          <table class="table">
            <thead>
                ...
                <th scope="col" class="text-center">Trucking order Id</th>
                <th scope="col" class="text-center">Mileage (Miles)</th>
                <th scope="col" class="text-center">ETA (minutes)</th>
            ...
            <?php for ($row = 0; $row < count($trucking_orders_data); $row++) {?>
              <tr>
                ...
                <th scope="row" class="text-center"><?php echo $trucking_orders_data[$row][0] ?></th>
                <th scope="row" class="text-center"><?php echo $trucking_orders_data[$row][10] ?></th>
                <th scope="row" class="text-center"><?php echo $trucking_orders_data[$row][11] ?></th>
